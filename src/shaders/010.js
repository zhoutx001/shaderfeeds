...
float pattern(vec2 st, vec2 v, float t) {
    vec2 p = floor(st+v);
    return step(t, random(13.360+p*0.088)+random(p.x)*0.876 );
}
...
void main() {
    ...
    vel *= vec2(0.000,0.080) * random(2.672+ipos.y); // direction

    // Assign a random value base on the integer coord
    vec2 offset = vec2(0.100,0.830);
